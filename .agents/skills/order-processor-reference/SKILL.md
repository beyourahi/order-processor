---
name: order-processor-reference
description: Detailed processing pipeline, AI copilot, auth, database, migration, environment, testing, and operational constraints. Read before changing those areas.
---
