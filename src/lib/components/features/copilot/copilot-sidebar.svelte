        ...
        <div class="border-chat-border-subtle border-t border-solid px-4 py-3" role="alert">
            <div class="border-chat-border bg-chat-surface flex items-start gap-3 rounded-xl border p-3">
                ...
                <div class="flex min-w-0 flex-col gap-2">
                    ...
                    <a
                        href="/settings"
                        class="text-chat-accent ease-[var(--ease)] hover:text-chat-text-primary text-caption inline-flex w-fit touch-manipulation items-center gap-1.5 font-mono tracking-[0.04em] whitespace-nowrap uppercase transition-colors"
                    >
                        Connect in Settings
