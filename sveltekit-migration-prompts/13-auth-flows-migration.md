...
<div class="flex min-h-screen flex-col items-center justify-center gap-8 p-8">
    ...
    <div class="flex gap-4">
        <a href="/" class="rounded-lg bg-zinc-800 px-4 py-2 text-sm hover:bg-zinc-700"> Home </a>
        <a href="/login" class="rounded-lg bg-zinc-800 px-4 py-2 text-sm hover:bg-zinc-700"> Login </a>
    </div>
</div>
```
